...
export const status = {
   ...
   //가게 존재 여부
   STORE_NOT_EXIST: {status:StatusCodes.NOT_FOUND, "isSuccess": false, "code": "STORE4001", "message": "가게가 없습니다"},

   //이미 도전 중
   ALREADY_CHALLENGED: {status:StatusCodes.NOT_ACCEPTABLE,"isSuccess": false, "code": "CHALLENGE4001", "message": "이미 도전중입니다"}
};